...
const Post = ({localArray}) => {
  ...
  return (
    <View style={styles.line}>
      {localArray.reverse().map((data, index) => {
        return (
          <View key={index} style={{marginBottom: 10}}>
            ...
            <View style={{height: 400}}>
              {/* data.postImage */}
              <Image source={{uri: data.postImage}} style={styles.ımage} />
            </View>
            ...
            <Text style={styles.likeText}>
              {checkLike(like, data.postName) ? data.like + 1 : data.like} Like
            </Text>
